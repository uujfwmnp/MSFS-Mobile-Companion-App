...
class AircraftEvents():
	...
	class __Avionics(EventHelper):
		list = [
			...
			(b'MobiFlight.JF_WARRIOR_AUTOPILOT_MODE_NAV', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_AUTOPILOT_MODE_OMNI', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_AUTOPILOT_MODE_HDG', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_AUTOPILOT_MODE_LOCNOMR', "-", "Shared Cockpit"),
			...
			(b'MobiFlight.JF_WARRIOR_KX170_NAV1_OUTER_KNOB_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_KX170_NAV1_INNER_KNOB_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_KX170_NAV1_INNER_KNOB_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_KX175_NAV2_OUTER_KNOB_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_KX175_NAV2_OUTER_KNOB_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_KX175_NAV2_INNER_KNOB_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_KX175_NAV2_INNER_KNOB_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_KX170_COMM1_OUTER_KNOB_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_KX170_COMM1_OUTER_KNOB_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_KX170_COMM1_INNER_KNOB_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_KX170_COMM1_INNER_KNOB_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_KX175_COMM2_OUTER_KNOB_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_KX175_COMM2_OUTER_KNOB_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_KX175_COMM2_INNER_KNOB_PLUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_KX175_COMM2_INNER_KNOB_MINUS', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_COM1_TRANSMIT', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_COM2_TRANSMIT', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_AUTOPILOT_SOURCE_NAV1', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_AUTOPILOT_SOURCE_NAV2', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_AUTOPILOT_SOURCE_OFF', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_FUEL_SELECT_cut', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_FUEL_SELECT_left', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_FUEL_SELECT_right', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_FLIGHT_BAG_toggle', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_LIGHTS_PANEL_toggle', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_LIGHTS_BCN_on', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_LIGHTS_BCN_off', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_LIGHTS_BCN_toggle', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_FUEL_PUMP_toggle', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_PITOT_HEAT_toggle', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_GPS100_RTE_press', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_GPS100_RTE_release', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_GPS100_WPT_press', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_GPS100_WPT_release', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_GPS100_NAV_press', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_GPS100_NAV_release', "-", "Shared Cockpit"),
			(b'MobiFlight.JF_WARRIOR_GPS100_LEFT_press', "-", "Shared Cockpit"),
